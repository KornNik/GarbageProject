...
{
    sealed class RunState : CharacterState
    {
        public RunState(CharacterStateController stateController) : base(stateController)
        {
        }
        ...
        protected override void InputHandle()
        {
            ...
            _stateController.StateObject.PlayerData.RunSpeed);
